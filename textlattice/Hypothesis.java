...
public class Hypothesis {
    private double pathScore;                  // Stores the cumulativepath score
    private java.util.ArrayList<String> words; // Array of words in thepath
    // Constructor
// Hypothesis
// Preconditions:
//     - None
...
//            For example, if word equals "going_to" then "going" it first
    ...
    public double computeWER(String referenceFilename) {
        ...
        try {
            input = new java.util.Scanner(new
                    java.io.File(referenceFilename));
        } catch( java.io.FileNotFoundException e ) {
            System.out.println("Error: File " + referenceFilename + " not found");
                    System.exit(1);
        }
        java.util.ArrayList<String> reference = new
